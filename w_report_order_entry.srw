$PBExportHeader$w_report_order_entry.srw
$PBExportComments$<popup> print order entry report with a preview, inherited from pfemain/w_sheet
forward
global type w_report_order_entry from w_sheet
end type
type dw_report from u_dw within w_report_order_entry
end type
type cb_setzoom from u_cb within w_report_order_entry
end type
type cb_print from u_cb within w_report_order_entry
end type
type p_1 from u_p within w_report_order_entry
end type
type cb_close from u_cb within w_report_order_entry
end type
end forward
...
global w_report_order_entry w_report_order_entry
...
on w_report_order_entry.create
int iCurrent
call super::create
...
on w_report_order_entry.destroy
call super::destroy
...
this.title = "Printing customer order # :  " + String(message.doubleparm)
dw_report.SetFocus()
...
integer height = 1136
integer taborder = 40
string dataobject = "d_report_order_entry"
