$PBExportHeader$u_ogihara_barcode.sru
$PBExportComments$default barcode form
forward
global type u_ogihara_barcode from u_report_object
end type
end forward
...
global u_ogihara_barcode u_ogihara_barcode
...
on u_ogihara_barcode.create
call super::create
end on

on u_ogihara_barcode.destroy
call super::destroy
end on
