$PBExportHeader$w_archived_bol.srw
forward
global type w_archived_bol from w_sheet
end type
type st_1 from statictext within w_archived_bol
end type
type cb_coil from commandbutton within w_archived_bol
end type
type cb_print from commandbutton within w_archived_bol
end type
type cb_close from commandbutton within w_archived_bol
end type
type dw_bol from u_dw within w_archived_bol
end type
end forward
...
global w_archived_bol w_archived_bol
...
destroy dboconnect;
*/
OpenWithParm(w_coil_list_by_archived_bol, lds_edi_file_id_and_bol)

/*
IF il_customer_id = 1153 THEN
	dw_bol.Retrieve('KINGSTON WORKS', 'STEEL WHEEL TRANSFER/88', 'GENERIC IMPORT WHSE/88')
ELSEIF il_customer_id = 1459 THEN
	dw_bol.Retrieve('PSI/OSW/OU', 'N/A', 'N/A')
END IF
*/
dw_bol.SetFocus()
...
integer taborder = 11
boolean bringtotop = true
string dataobject = "d_archived_bol"
