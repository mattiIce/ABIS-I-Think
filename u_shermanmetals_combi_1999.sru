$PBExportHeader$u_shermanmetals_combi_1999.sru
$PBExportComments$Sherman Metals packinglist & billoflading combination  form
forward
global type u_shermanmetals_combi_1999 from u_report_object
end type
end forward
...
global u_shermanmetals_combi_1999 u_shermanmetals_combi_1999
...
lds_print.DataObject = "d_report_abco_combi_form_sm"  
...
ls_modstring = "packing_list_t.Text = ~"" + String(ll_bill_lading) + "~""	
ads_print.Modify(ls_modstring) 
ls_modstring = "bill_lading_t.Text = ~"" + String(ll_bill_lading) + "~""	
ads_print.Modify(ls_modstring) 
ls_modstring = "date_t.Text = ~"" + String(ld_date, "mm/dd/yyyy hh:mm") + "~""	
...
on u_shermanmetals_combi_1999.create
call super::create
end on

on u_shermanmetals_combi_1999.destroy
call super::destroy
end on
