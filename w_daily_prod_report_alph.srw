$PBExportHeader$w_daily_prod_report_alph.srw
$PBExportComments$Average lbs per hour report
forward
global type w_daily_prod_report_alph from w_sheet
end type
type dw_report from u_dw within w_daily_prod_report_alph
end type
type cb_setzoom from u_cb within w_daily_prod_report_alph
end type
type cb_print from u_cb within w_daily_prod_report_alph
end type
type cbx_setpreview from u_cbx within w_daily_prod_report_alph
end type
type cb_close from u_cb within w_daily_prod_report_alph
end type
end forward
...
global w_daily_prod_report_alph w_daily_prod_report_alph

type variables

end variables

on w_daily_prod_report_alph.create
int iCurrent
call super::create
...
on w_daily_prod_report_alph.destroy
call super::destroy
...
dw_report.object.gr_1.title  = lstr_q.line_desc + " Average LBs Per Hr " + " between " + String(lstr_q.start_date) + " and " + String(lstr_q.end_date)
...
int Height=1546
int TabOrder=40
string DataObject="d_daily_prod_shift_average_new"
