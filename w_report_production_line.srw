$PBExportHeader$w_report_production_line.srw
$PBExportComments$ production line report based on different customers
forward
global type w_report_production_line from w_sheet
end type
type dw_report from u_dw within w_report_production_line
end type
type cb_print from u_cb within w_report_production_line
end type
type cb_close from u_cb within w_report_production_line
end type
type cb_setzoom from u_cb within w_report_production_line
end type
type gb_5 from u_gb within w_report_production_line
end type
type gb_4 from u_gb within w_report_production_line
end type
type gb_3 from u_gb within w_report_production_line
end type
type gb_2 from u_gb within w_report_production_line
end type
type gb_1 from u_gb within w_report_production_line
end type
type rb_lineall from u_rb within w_report_production_line
end type
type rb_line from u_rb within w_report_production_line
end type
type rb_dateall from u_rb within w_report_production_line
end type
type rb_date from u_rb within w_report_production_line
end type
type rb_custall from u_rb within w_report_production_line
end type
type rb_cust from u_rb within w_report_production_line
end type
type rb_enduserall from u_rb within w_report_production_line
end type
type rb_enduser from u_rb within w_report_production_line
end type
type ddlb_line from u_ddlb within w_report_production_line
end type
type em_from from u_em within w_report_production_line
end type
type em_to from u_em within w_report_production_line
end type
type st_1 from statictext within w_report_production_line
end type
type ddlb_cust from u_ddlb within w_report_production_line
end type
type ddlb_enduser from u_ddlb within w_report_production_line
end type
type dw_allcust from u_dw within w_report_production_line
end type
type dw_customer from u_dw within w_report_production_line
end type
type cb_retrieve from u_cb within w_report_production_line
end type
type dw_line from u_dw within w_report_production_line
end type
type rb_statusall from u_rb within w_report_production_line
end type
type rb_status from u_rb within w_report_production_line
end type
type ddlb_status from u_ddlb within w_report_production_line
end type
end forward
...
integer width = 2491
integer height = 1738
string title = "Production Line Report"
...
global w_report_production_line w_report_production_line
...
event ue_whoami;RETURN "w_report_production_line"
end event
...
IF rb_custall.Checked THEN
	ls_s = "ABCO Customer Production Line Report" 	
ELSE
	ls_s = is_cust + " Production Line Report"
END IF	
...
on w_report_production_line.create
int iCurrent
call super::create
...
on w_report_production_line.destroy
call super::destroy
...
integer height = 1158
integer taborder = 10
string dataobject = "d_report_prd_abc_cust_allline"
...
This.Reset()
This.DataObject = "d_report_prd_abc_cust_allline"
