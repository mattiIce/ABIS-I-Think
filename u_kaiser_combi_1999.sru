$PBExportHeader$u_kaiser_combi_1999.sru
$PBExportComments$kaiser packinglist & billoflading combination  form
forward
global type u_kaiser_combi_1999 from u_report_object
end type
end forward
...
global u_kaiser_combi_1999 u_kaiser_combi_1999
...
lds_print.DataObject = "d_report_abco_combi_form_kaiser"  
...
event type integer ue_print_sheetskid(long al_shipment);Int li_totalrow, li_totaljob, li_i
	...
	IF li_totaljob > 0 THEN
		FOR li_i = 1 TO li_totaljob
			...
			FOR li_s = 1 TO ids_sheet.RowCount()
				...
				SELECT ab_job_num, sheet_net_wt, skid_pieces, sheet_tare_wt 
				INTO :ll_job_num, :ll_net_wt, :ll_skidpc, :ll_tarewt
				FROM sheet_skid
...
on u_kaiser_combi_1999.create
call super::create
end on

on u_kaiser_combi_1999.destroy
call super::destroy
end on
