$PBExportHeader$u_novelis_ford_barcode.sru
$PBExportComments$barcode for novelis shipment to ford
forward
global type u_novelis_ford_barcode from u_report_object
end type
end forward
...
global u_novelis_ford_barcode u_novelis_ford_barcode
...
on u_novelis_ford_barcode.create
call super::create
end on

on u_novelis_ford_barcode.destroy
call super::destroy
end on

event constructor;call super::constructor;is_objectname = "d_report_barcode_novelis_ford"
li_allowsetup = 1
