$PBExportHeader$u_line_status_button.sru
forward
global type u_line_status_button from userobject
end type
type st_1 from statictext within u_line_status_button
end type
type p_2 from picture within u_line_status_button
end type
type p_1 from picture within u_line_status_button
end type
end forward
...
global u_line_status_button u_line_status_button
...
on u_line_status_button.create
...
on u_line_status_button.destroy
destroy(this.st_1)
destroy(this.p_2)
destroy(this.p_1)
end on
...
integer width = 66
integer height = 61
string picturename = ".\YellowLight.gif"
boolean focusrectangle = false
end type
