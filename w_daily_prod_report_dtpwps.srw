$PBExportHeader$w_daily_prod_report_dtpwps.srw
$PBExportComments$<PopUp> daily_production daily total peocess wt per line per shift report preview window inherited form pfemain/w_sheet
forward
global type w_daily_prod_report_dtpwps from w_sheet
end type
type dw_report from u_dw within w_daily_prod_report_dtpwps
end type
type cb_setzoom from u_cb within w_daily_prod_report_dtpwps
end type
type cb_print from u_cb within w_daily_prod_report_dtpwps
end type
type cbx_setpreview from u_cbx within w_daily_prod_report_dtpwps
end type
type cb_close from u_cb within w_daily_prod_report_dtpwps
end type
end forward
...
global w_daily_prod_report_dtpwps w_daily_prod_report_dtpwps

type variables
Date id_d
end variables

on w_daily_prod_report_dtpwps.create
int iCurrent
call super::create
...
on w_daily_prod_report_dtpwps.destroy
call super::destroy
...
int Height=1568
int TabOrder=40
string DataObject="d_daily_prod_total_wt_per_line_per_shift"
