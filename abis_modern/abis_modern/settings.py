"""
Django settings for ABIS Modern project.
"""
...
WSGI_APPLICATION = 'abis_modern.wsgi.application'

# Database
# Use SQLite for local development, PostgreSQL for production
if os.getenv('USE_SQLITE', 'True') == 'True' and DEBUG:
    DATABASES = {
        'default': {
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'abis_db'),
            'USER': os.getenv('DB_USER', 'abis_user'),
...
# Whitenoise configuration for Django 5.1+
STORAGEFILES = {
    "default": {
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'ABIS Modern API',
    'DESCRIPTION': 'Aluminum Business Information System - Modern REST API',
    'VERSION': '1.0.0',
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'abis.log',
            'formatter': 'verbose',
        },
    },
    'root': {
