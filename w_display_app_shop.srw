$PBExportHeader$w_display_app_shop.srw
$PBExportComments$display applications of this system used only in shop area
forward
global type w_display_app_shop from w_sheet
end type
type st_7 from statictext within w_display_app_shop
end type
type st_6 from statictext within w_display_app_shop
end type
type st_5 from statictext within w_display_app_shop
end type
type st_4 from statictext within w_display_app_shop
end type
type st_3 from statictext within w_display_app_shop
end type
type st_2 from statictext within w_display_app_shop
end type
type pb_receiving from u_pb within w_display_app_shop
end type
type pb_scheduler from u_pb within w_display_app_shop
end type
type pb_scale from u_pb within w_display_app_shop
end type
type pb_downtime from u_pb within w_display_app_shop
end type
type pb_quality from u_pb within w_display_app_shop
end type
type pb_dashboard from u_pb within w_display_app_shop
end type
type p_2 from picture within w_display_app_shop
end type
type p_3 from picture within w_display_app_shop
end type
type cb_1 from commandbutton within w_display_app_shop
end type
type st_1 from statictext within w_display_app_shop
end type
end forward
...
global w_display_app_shop w_display_app_shop

event type string ue_whoami();RETURN "w_display_app_shop"
end event

on w_display_app_shop.create
int iCurrent
call super::create
...
string text = ""
boolean originalsize = false
string picturename = "scheduler.gif"
end type
...
event clicked;call super::clicked;IF this.Enabled THEN
	Message.StringParm = "w_scale_item_selection" 
