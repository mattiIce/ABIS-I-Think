$PBExportHeader$u_coil_barcode.sru
$PBExportComments$default barcode form
forward
global type u_coil_barcode from u_report_object
end type
end forward
...
global u_coil_barcode u_coil_barcode
...
on u_coil_barcode.create
call super::create
end on

on u_coil_barcode.destroy
call super::destroy
end on

event constructor;call super::constructor;is_objectname = "d_coil_barcode"
li_allowsetup = 1
...
li_argumenttype = 4 //Coil barcode
