$PBExportHeader$u_flint_d13_barcode.sru
$PBExportComments$default barcode form
forward
global type u_flint_d13_barcode from u_report_object
end type
end forward
...
global u_flint_d13_barcode u_flint_d13_barcode
...
String ls_alloy
Datetime ld_actual_shipping_date
...
on u_flint_d13_barcode.create
call super::create
end on

on u_flint_d13_barcode.destroy
call super::destroy
end on

event constructor;call super::constructor;is_objectname = "d_report_barcode_flint_d13"
li_allowsetup = 1
