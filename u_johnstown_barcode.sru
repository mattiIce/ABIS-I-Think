$PBExportHeader$u_johnstown_barcode.sru
forward
global type u_johnstown_barcode from u_report_object
end type
end forward
...
global u_johnstown_barcode u_johnstown_barcode
...
on u_johnstown_barcode.create
call super::create
end on

on u_johnstown_barcode.destroy
call super::destroy
end on
