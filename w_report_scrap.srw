$PBExportHeader$w_report_scrap.srw
forward
global type w_report_scrap from w_sheet
end type
type st_6 from statictext within w_report_scrap
end type
type dw_customer_lookup from datawindow within w_report_scrap
end type
type cb_export from u_cb within w_report_scrap
end type
type dw_scrap_type_lookup from datawindow within w_report_scrap
end type
type st_5 from statictext within w_report_scrap
end type
type dw_sheet_type_desc_lookup from datawindow within w_report_scrap
end type
type st_4 from statictext within w_report_scrap
end type
type st_3 from statictext within w_report_scrap
end type
type dw_temper_lookup from datawindow within w_report_scrap
end type
type st_2 from statictext within w_report_scrap
end type
type dw_alloy_lookup from datawindow within w_report_scrap
end type
type dw_line_lookup from datawindow within w_report_scrap
end type
type dw_rebanded_list from datawindow within w_report_scrap
end type
type dw_rejcoil_list from datawindow within w_report_scrap
end type
type st_note from statictext within w_report_scrap
end type
type st_rowcount from statictext within w_report_scrap
end type
type cbx_all_dates from checkbox within w_report_scrap
end type
type cb_1 from commandbutton within w_report_scrap
end type
type st_all_dates from statictext within w_report_scrap
end type
type cb_retrieve from commandbutton within w_report_scrap
end type
type em_from from editmask within w_report_scrap
end type
type em_to from editmask within w_report_scrap
end type
type st_1 from statictext within w_report_scrap
end type
type st_from from statictext within w_report_scrap
end type
type st_to from statictext within w_report_scrap
end type
type cbx_dateall from checkbox within w_report_scrap
end type
type dw_report from u_dw within w_report_scrap
end type
type cb_close from u_cb within w_report_scrap
end type
type cb_print from u_cb within w_report_scrap
end type
end forward
...
cb_export cb_export
dw_scrap_type_lookup dw_scrap_type_lookup
st_5 st_5
dw_sheet_type_desc_lookup dw_sheet_type_desc_lookup
st_4 st_4
st_3 st_3
dw_temper_lookup dw_temper_lookup
st_2 st_2
dw_alloy_lookup dw_alloy_lookup
...
global w_report_scrap w_report_scrap
...
event type string ue_whoami();Return "w_report_scrap"
end event
...
//Column Headings
lole_OLE.cells[1,1] = "ABCo Job #"
lole_OLE.cells[1,2] = "BL #"
lole_OLE.cells[1,3] = "Job Done Date"
lole_OLE.cells[1,4] = "Customer Name"
lole_OLE.cells[1,5] = "Material End Use"
lole_OLE.cells[1,6] = "Alloy"
lole_OLE.cells[1,7] = "Temper"
lole_OLE.cells[1,8] = "Gauge"
lole_OLE.cells[1,9] = "Width"
lole_OLE.cells[1,10] = "Total Process Wt"
lole_OLE.cells[1,11] = "Total Scrap Wt"
lole_OLE.cells[1,12] = "Scrap Handling Type"
lole_OLE.cells[1,13] = "Sheet Type"
lole_OLE.cells[1,14] = "AB Die #"
...
lole_OLE.cells[1,1] = "Scrap Report"
lole_Sheet.Range("A1:A1").Select
lole_OLE.Selection.Font.Bold = True
...
lole_OLE.cells[1,4] = ls_run_date
...
lole_OLE.cells[8,1] = is_customer_head_t
...
lole_Sheet.Range("A4:G" + String(ll_report_rows + 9)).Select
lole_OLE.Selection.HorizontalAlignment = -4131 //Left justify

lole_Sheet.Range("L4:N" + String(ll_report_rows + 9)).Select
lole_OLE.Selection.HorizontalAlignment = -4131 //Left justify
...
ls_file = ls_folder + "Scrap Report" + "_" + ls_today + ls_now + ".xls"
...
on w_report_scrap.create
int iCurrent
call super::create
this.st_6=create st_6
this.dw_customer_lookup=create dw_customer_lookup
this.cb_export=create cb_export
this.dw_scrap_type_lookup=create dw_scrap_type_lookup
this.st_5=create st_5
this.dw_sheet_type_desc_lookup=create dw_sheet_type_desc_lookup
this.st_4=create st_4
this.st_3=create st_3
this.dw_temper_lookup=create dw_temper_lookup
this.st_2=create st_2
this.dw_alloy_lookup=create dw_alloy_lookup
...
this.Control[iCurrent+4]=this.dw_scrap_type_lookup
this.Control[iCurrent+5]=this.st_5
this.Control[iCurrent+6]=this.dw_sheet_type_desc_lookup
this.Control[iCurrent+7]=this.st_4
this.Control[iCurrent+8]=this.st_3
this.Control[iCurrent+9]=this.dw_temper_lookup
this.Control[iCurrent+10]=this.st_2
this.Control[iCurrent+11]=this.dw_alloy_lookup
this.Control[iCurrent+12]=this.dw_line_lookup
this.Control[iCurrent+13]=this.dw_rebanded_list
this.Control[iCurrent+14]=this.dw_rejcoil_list
this.Control[iCurrent+15]=this.st_note
this.Control[iCurrent+16]=this.st_rowcount
this.Control[iCurrent+17]=this.cbx_all_dates
this.Control[iCurrent+18]=this.cb_1
this.Control[iCurrent+19]=this.st_all_dates
this.Control[iCurrent+20]=this.cb_retrieve
this.Control[iCurrent+21]=this.em_from
this.Control[iCurrent+22]=this.em_to
this.Control[iCurrent+23]=this.st_1
this.Control[iCurrent+24]=this.st_from
this.Control[iCurrent+25]=this.st_to
this.Control[iCurrent+26]=this.cbx_dateall
this.Control[iCurrent+27]=this.dw_report
this.Control[iCurrent+28]=this.cb_close
this.Control[iCurrent+29]=this.cb_print
end on

on w_report_scrap.destroy
call super::destroy
destroy(this.st_6)
destroy(this.dw_customer_lookup)
destroy(this.cb_export)
destroy(this.dw_scrap_type_lookup)
destroy(this.st_5)
destroy(this.dw_sheet_type_desc_lookup)
destroy(this.st_4)
destroy(this.st_3)
destroy(this.dw_temper_lookup)
destroy(this.st_2)
destroy(this.dw_alloy_lookup)
...
event pfc_postopen;call super::pfc_postopen;This.Width = 5036
This.Height = 2512

dw_report.Width = 4915
dw_report.Height = 1891
...
ls_file = "c:\temp\Scrap Report " + ls_date_from + "-" + ls_date_to + ".xls"
...
integer taborder = 20
string title = "none"
string dataobject = "d_scrap_type_lookup"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
...
long textcolor = 33554432
long backcolor = 79741120
string text = "Scrap Handling Type"
boolean focusrectangle = false
end type
...
integer taborder = 10
string title = "none"
string dataobject = "d_temper_lookup"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
...
integer taborder = 40
string title = "none"
string dataobject = "d_alloy_lookup"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
...
integer taborder = 30
string title = "none"
string dataobject = "d_line_lookup"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
...
Else
	...
	If ls_date_from = ls_date_to Then
		is_date_range_head_t = "Job Done Date: " + ls_date_from
	Else
		is_date_range_head_t = "Job Done Date between " + ls_date_from + " and " + ls_date_to
	End If
	
	ls_add_2sql_where = ls_add_2sql_where + " and ab_job.job_done_time between to_date( '" + ls_date_from + " 00:00:00', 'mm/dd/yyyy hh24:mi:ss' )" + &
								" and to_date( '" + ls_date_to + " 23:59:59', 'mm/dd/yyyy hh24:mi:ss' )  "
End If
...
Else
	ls_add_2sql_where = ls_add_2sql_where + " and c1.customer_id = " + String(ll_customer_id)
...
ls_sql_new = ls_sql_new + " order by ab_job.ab_job_num"
...
integer height = 1552
integer taborder = 10
string dataobject = "d_report_scrap"
