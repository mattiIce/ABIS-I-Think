$PBExportHeader$w_finish_coil.srw
forward
global type w_finish_coil from w_response
end type
type cb_ok from commandbutton within w_finish_coil
end type
type cb_canel from commandbutton within w_finish_coil
end type
type rb_done from radiobutton within w_finish_coil
end type
type rb_reject from radiobutton within w_finish_coil
end type
type rb_onhold from radiobutton within w_finish_coil
end type
type rb_rebanded from radiobutton within w_finish_coil
end type
type rb_inprocess from radiobutton within w_finish_coil
end type
type st_new_wt from statictext within w_finish_coil
end type
type st_wt_prompt from statictext within w_finish_coil
end type
type st_1 from statictext within w_finish_coil
end type
type st_2 from statictext within w_finish_coil
end type
type st_coil_org_num from statictext within w_finish_coil
end type
type st_4 from statictext within w_finish_coil
end type
type st_5 from statictext within w_finish_coil
end type
type st_old_nw from statictext within w_finish_coil
end type
type st_3 from statictext within w_finish_coil
end type
type st_warning from statictext within w_finish_coil
end type
type gb_status from groupbox within w_finish_coil
end type
end forward
...
global w_finish_coil w_finish_coil
...
st_new_wt.text = string( iu_coil.get_nw_bal( ) )
ii_new_status = 3
end event
...
event clicked;if iu_coil.get_coil_shift_status( ) = 2 then
	...
	choose case ii_new_status
		case 0	//done
			iu_coil.finish( 0, 0)
		case 4	//onhold
			if Long(st_new_wt.text) < iu_coil.get_old_nw( ) then
...
long textcolor = 8388608
long backcolor = 67108864
string text = "had been unloaded, please update"
end type
