$PBExportHeader$u_alcoa_combi_1999.sru
$PBExportComments$ALCOA packinglist & billoflading combination  form
forward
global type u_alcoa_combi_1999 from u_report_object
end type
end forward
...
global u_alcoa_combi_1999 u_alcoa_combi_1999
...
Int li_i, li_totalrow, li_skidcount
...
lds_print.DataObject = "d_report_abco_combi_form_alcoa"  
...
Long ll_jobpc, ll_jobnet,  ll_jobtheo, ll_jobtare, li_skidcount, ref_order
...
If lb_use_package_num Then
	lds_print.DataObject = "d_report_abco_combi_form_alcoa_pn"
End If
...
//ls_modstring = "shipper_t.Text = ~"" + Right( String( al_shipment ), 4 ) + "~""	
ls_modstring = "shipper_t.Text = ~"" + String( al_shipment ) + "~""	
...
on u_alcoa_combi_1999.create
call super::create
end on

on u_alcoa_combi_1999.destroy
call super::destroy
end on
