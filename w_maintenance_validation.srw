$PBExportHeader$w_maintenance_validation.srw
forward
global type w_maintenance_validation from w_response
end type
type cb_ok from commandbutton within w_maintenance_validation
end type
type cb_1 from commandbutton within w_maintenance_validation
end type
type st_password from statictext within w_maintenance_validation
end type
type st_2 from statictext within w_maintenance_validation
end type
type st_super_name from statictext within w_maintenance_validation
end type
type st_1 from statictext within w_maintenance_validation
end type
type st_warning from statictext within w_maintenance_validation
end type
end forward
...
global w_maintenance_validation w_maintenance_validation
...
on w_maintenance_validation.create
int iCurrent
call super::create
...
on w_maintenance_validation.destroy
call super::destroy
destroy(this.cb_ok)
destroy(this.cb_1)
...
long textcolor = 8388608
long backcolor = 67108864
string text = "Maintenance supervisor"
boolean focusrectangle = false
end type
