$PBExportHeader$w_report_general.srw
$PBExportComments$<PopUp> standard report preview window inherited form pfemain/w_sheet
forward
global type w_report_general from w_sheet
end type
type dw_report from u_dw within w_report_general
end type
type cb_setzoom from u_cb within w_report_general
end type
type cb_print from u_cb within w_report_general
end type
type cbx_setpreview from u_cbx within w_report_general
end type
type p_1 from u_p within w_report_general
end type
type cb_close from u_cb within w_report_general
end type
end forward
...
global w_report_general w_report_general

on w_report_general.create
int iCurrent
call super::create
