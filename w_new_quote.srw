$PBExportHeader$w_new_quote.srw
$PBExportComments$<Child> Create a new quote
forward
global type w_new_quote from w_child
end type
type st_9 from statictext within w_new_quote
end type
type pb_9 from u_pb within w_new_quote
end type
type st_8 from statictext within w_new_quote
end type
type pb_8 from u_pb within w_new_quote
end type
type st_7 from statictext within w_new_quote
end type
type pb_7 from u_pb within w_new_quote
end type
type st_6 from statictext within w_new_quote
end type
type pb_6 from u_pb within w_new_quote
end type
type st_1 from statictext within w_new_quote
end type
type pb_5 from u_pb within w_new_quote
end type
type pb_1 from u_pb within w_new_quote
end type
type st_5 from statictext within w_new_quote
end type
type pb_4 from u_pb within w_new_quote
end type
type st_4 from statictext within w_new_quote
end type
type st_3 from statictext within w_new_quote
end type
type pb_3 from u_pb within w_new_quote
end type
type pb_2 from u_pb within w_new_quote
end type
type st_2 from statictext within w_new_quote
end type
type dw_quote from u_dw within w_new_quote
end type
type gb_5 from groupbox within w_new_quote
end type
type gb_4 from groupbox within w_new_quote
end type
type gb_1 from groupbox within w_new_quote
end type
type gb_2 from groupbox within w_new_quote
end type
type gb_3 from groupbox within w_new_quote
end type
end forward
...
integer width = 4447
integer height = 2045
string title = "Create a new quote"
st_9 st_9
pb_9 pb_9
st_8 st_8
pb_8 pb_8
...
global w_new_quote w_new_quote

type variables
s_quote_data ids_q
end variables

on w_new_quote.create
int iCurrent
call super::create
...
dw_quote.Event pfc_addrow()

IF ids_q.customer_id = 0 THEN
	OpenwithParm(w_new_quote_selection, ids_q)
