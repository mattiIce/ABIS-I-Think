$PBExportHeader$u_ogihara_barcode_scale.sru
$PBExportComments$print ogihara barcode from scale
forward
global type u_ogihara_barcode_scale from u_report_object
end type
end forward
...
global u_ogihara_barcode_scale u_ogihara_barcode_scale
...
String ls_orig_po, ls_enduser_po, ls_supplier_code, ls_part_num, ls_ref
...
SELECT orig_customer_id, enduser_id, orig_customer_po, enduser_po, reference
INTO :ll_orig_cust, :ll_enduser, :ls_orig_po, :ls_enduser_po, :ls_ref
FROM customer_order
...
//1st form
String ls_modstring
ls_modstring = "part_num_t.Text = ~"" + ls_ref + "~""
idw_requestor.Modify(ls_modstring) 
ls_modstring = "bar_part_num_t.Text = ~"*" + is_1 + ls_ref +"*~"" 
idw_requestor.Modify(ls_modstring)
ls_modstring = "bar_part_num_t_up.Text = ~"*" + is_1 + ls_ref +"*~"" 
idw_requestor.Modify(ls_modstring)
...
ls_modstring = "cust_order_t.Text = ~"" + ls_part_num + "~""
idw_requestor.Modify(ls_modstring)
ls_modstring = "bar_cust_order_t.Text = ~"*" + is_4 + ls_part_num + "*~""
idw_requestor.Modify(ls_modstring)
ls_modstring = "bar_cust_order_t_up.Text = ~"*" + is_4 + ls_part_num + "*~""
idw_requestor.Modify(ls_modstring)
...
on u_ogihara_barcode_scale.create
call super::create
end on

on u_ogihara_barcode_scale.destroy
call super::destroy
end on

event constructor;call super::constructor;is_objectname = "d_report_barcode_ogihara"
li_allowsetup = 1
