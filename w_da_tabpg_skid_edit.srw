$PBExportHeader$w_da_tabpg_skid_edit.srw
forward
global type w_da_tabpg_skid_edit from w_popup
end type
type cb_close from u_cb within w_da_tabpg_skid_edit
end type
type cb_cancel from u_cb within w_da_tabpg_skid_edit
end type
type cb_save from u_cb within w_da_tabpg_skid_edit
end type
type dw_edit from u_dw within w_da_tabpg_skid_edit
end type
end forward
...
global w_da_tabpg_skid_edit w_da_tabpg_skid_edit
...
iu_da_skid_tabpg.dw_skid_item.object.production_sheet_item_prod_item_status[ll_row] = dw_edit.object.production_sheet_item_prod_item_status[1]
...
on w_da_tabpg_skid_edit.create
int iCurrent
call super::create
...
on w_da_tabpg_skid_edit.destroy
call super::destroy
