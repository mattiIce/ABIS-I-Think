$PBExportHeader$u_default_barcode_scale.sru
$PBExportComments$default barcode form from scale
forward
global type u_default_barcode_scale from u_report_object
end type
end forward
...
global u_default_barcode_scale u_default_barcode_scale
...
on u_default_barcode_scale.create
call super::create
end on

on u_default_barcode_scale.destroy
call super::destroy
end on
