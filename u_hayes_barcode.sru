$PBExportHeader$u_hayes_barcode.sru
forward
global type u_hayes_barcode from u_report_object
end type
end forward
...
global u_hayes_barcode u_hayes_barcode
...
on u_hayes_barcode.create
call super::create
end on

on u_hayes_barcode.destroy
call super::destroy
end on
