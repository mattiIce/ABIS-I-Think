...
forward
global type w_please_wait from w_popup
end type
type st_msg from statictext within w_please_wait
end type
type st_1 from statictext within w_please_wait
end type
type p_1 from picture within w_please_wait
end type
end forward
