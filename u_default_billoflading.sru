$PBExportHeader$u_default_billoflading.sru
$PBExportComments$default bill of lading
forward
global type u_default_billoflading from u_report_object
end type
end forward

global type u_default_billoflading from u_report_object
end type
global u_default_billoflading u_default_billoflading

on u_default_billoflading.create
TriggerEvent( this, "constructor" )
end on

on u_default_billoflading.destroy
