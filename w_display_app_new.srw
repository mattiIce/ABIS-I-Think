$PBExportHeader$w_display_app_new.srw
$PBExportComments$display applications of this system
forward
global type w_display_app_new from w_sheet
end type
type cb_2 from commandbutton within w_display_app_new
end type
type uo_inventory from u_dispalyappbutton within w_display_app_new
end type
type st_recap_bl110 from statictext within w_display_app_new
end type
type st_doc from statictext within w_display_app_new
end type
type st_bl110 from statictext within w_display_app_new
end type
type st_line from statictext within w_display_app_new
end type
type st_camera from statictext within w_display_app_new
end type
type st_sheetpro from statictext within w_display_app_new
end type
type st_circlepro from statictext within w_display_app_new
end type
type st_orderentry from statictext within w_display_app_new
end type
type st_production from statictext within w_display_app_new
end type
type st_scrap from statictext within w_display_app_new
end type
type st_warehouse from statictext within w_display_app_new
end type
type st_shipping from statictext within w_display_app_new
end type
type st_receiving from statictext within w_display_app_new
end type
type st_loading from statictext within w_display_app_new
end type
type st_coil from statictext within w_display_app_new
end type
type st_skid from statictext within w_display_app_new
end type
type st_recap from statictext within w_display_app_new
end type
type st_skidentry from statictext within w_display_app_new
end type
type st_2 from statictext within w_display_app_new
end type
type st_shipment from statictext within w_display_app_new
end type
type st_inventory from statictext within w_display_app_new
end type
type st_edi from statictext within w_display_app_new
end type
type st_qc from statictext within w_display_app_new
end type
type cb_1 from commandbutton within w_display_app_new
end type
type st_schedule from statictext within w_display_app_new
end type
type st_dailyprod from statictext within w_display_app_new
end type
type st_1 from statictext within w_display_app_new
end type
type st_downtime from statictext within w_display_app_new
end type
type st_shiftschedule from statictext within w_display_app_new
end type
end forward
...
global w_display_app_new w_display_app_new

event ue_whoami;RETURN "w_display_app"
end event

on w_display_app_new.create
int iCurrent
call super::create
this.cb_2=create cb_2
this.uo_inventory=create uo_inventory
...
this.Control[iCurrent+2]=this.uo_inventory
this.Control[iCurrent+3]=this.st_recap_bl110
this.Control[iCurrent+4]=this.st_doc
this.Control[iCurrent+5]=this.st_bl110
this.Control[iCurrent+6]=this.st_line
this.Control[iCurrent+7]=this.st_camera
...
this.Control[iCurrent+28]=this.st_dailyprod
this.Control[iCurrent+29]=this.st_1
this.Control[iCurrent+30]=this.st_downtime
this.Control[iCurrent+31]=this.st_shiftschedule
end on

on w_display_app_new.destroy
call super::destroy
destroy(this.cb_2)
destroy(this.uo_inventory)
...
event clicked;uo_inventory.PostEvent("LostFocus")
end event
...
on uo_inventory.destroy
call u_dispalyappbutton::destroy
end on

event constructor;call super::constructor;cb_1.Text = "Inventory"
P_1.PictureName = "coil_inventory.jpg"
end event
