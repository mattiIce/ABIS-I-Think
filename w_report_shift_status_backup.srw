$PBExportHeader$w_report_shift_status_backup.srw
$PBExportComments$ Current shift status based on production line based on different customers
forward
global type w_report_shift_status_backup from w_sheet
end type
type tab_shift from tab within w_report_shift_status_backup
end type
...
type st_timer from statictext within w_report_shift_status_backup
end type
type cb_close from u_cb within w_report_shift_status_backup
end type
type cb_retrieve from u_cb within w_report_shift_status_backup
end type
end forward
...
global w_report_shift_status_backup w_report_shift_status_backup
...
on w_report_shift_status_backup.create
int iCurrent
call super::create
...
on w_report_shift_status_backup.destroy
call super::destroy
