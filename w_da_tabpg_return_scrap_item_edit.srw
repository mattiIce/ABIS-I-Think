$PBExportHeader$w_da_tabpg_return_scrap_item_edit.srw
forward
global type w_da_tabpg_return_scrap_item_edit from w_popup
end type
type cb_close from u_cb within w_da_tabpg_return_scrap_item_edit
end type
type cb_cancel from u_cb within w_da_tabpg_return_scrap_item_edit
end type
type cb_save from u_cb within w_da_tabpg_return_scrap_item_edit
end type
type dw_edit from u_dw within w_da_tabpg_return_scrap_item_edit
end type
end forward
...
global w_da_tabpg_return_scrap_item_edit w_da_tabpg_return_scrap_item_edit
...
public function integer wf_data_validation ();if dw_edit.object.return_scrap_item_return_item_net_wt[1] < 1 or dw_edit.object.return_scrap_item_return_item_net_wt[1] > 8000 then
...
on w_da_tabpg_return_scrap_item_edit.create
int iCurrent
call super::create
...
on w_da_tabpg_return_scrap_item_edit.destroy
call super::destroy
