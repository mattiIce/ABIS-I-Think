$PBExportHeader$w_display_app.srw
$PBExportComments$display applications of this system
forward
global type w_display_app from w_sheet
end type
type st_bl84 from statictext within w_display_app
end type
type st_recap_bl110 from statictext within w_display_app
end type
type st_doc from statictext within w_display_app
end type
type st_bl110 from statictext within w_display_app
end type
type st_line from statictext within w_display_app
end type
type st_camera from statictext within w_display_app
end type
type p_2 from picture within w_display_app
end type
type st_sheetpro from statictext within w_display_app
end type
type st_circlepro from statictext within w_display_app
end type
type st_orderentry from statictext within w_display_app
end type
type st_production from statictext within w_display_app
end type
type st_scrap from statictext within w_display_app
end type
type st_warehouse from statictext within w_display_app
end type
type st_shipping from statictext within w_display_app
end type
type st_receiving from statictext within w_display_app
end type
type st_loading from statictext within w_display_app
end type
type st_coil from statictext within w_display_app
end type
type st_skid from statictext within w_display_app
end type
type st_recap from statictext within w_display_app
end type
type st_skidentry from statictext within w_display_app
end type
type st_2 from statictext within w_display_app
end type
type st_shipment from statictext within w_display_app
end type
type st_inventory from statictext within w_display_app
end type
type p_3 from picture within w_display_app
end type
type st_edi from statictext within w_display_app
end type
type st_qc from statictext within w_display_app
end type
type cb_1 from commandbutton within w_display_app
end type
type st_schedule from statictext within w_display_app
end type
type p_1 from picture within w_display_app
end type
type st_dailyprod from statictext within w_display_app
end type
type st_1 from statictext within w_display_app
end type
type st_downtime from statictext within w_display_app
end type
type st_shiftschedule from statictext within w_display_app
end type
end forward
...
global w_display_app w_display_app

event ue_whoami;RETURN "w_display_app"
end event

on w_display_app.create
int iCurrent
call super::create
this.st_bl84=create st_bl84
...
this.Control[iCurrent+1]=this.st_bl84
this.Control[iCurrent+2]=this.st_recap_bl110
this.Control[iCurrent+3]=this.st_doc
this.Control[iCurrent+4]=this.st_bl110
this.Control[iCurrent+5]=this.st_line
this.Control[iCurrent+6]=this.st_camera
this.Control[iCurrent+7]=this.p_2
this.Control[iCurrent+8]=this.st_sheetpro
this.Control[iCurrent+9]=this.st_circlepro
this.Control[iCurrent+10]=this.st_orderentry
this.Control[iCurrent+11]=this.st_production
this.Control[iCurrent+12]=this.st_scrap
this.Control[iCurrent+13]=this.st_warehouse
this.Control[iCurrent+14]=this.st_shipping
this.Control[iCurrent+15]=this.st_receiving
this.Control[iCurrent+16]=this.st_loading
this.Control[iCurrent+17]=this.st_coil
this.Control[iCurrent+18]=this.st_skid
this.Control[iCurrent+19]=this.st_recap
this.Control[iCurrent+20]=this.st_skidentry
this.Control[iCurrent+21]=this.st_2
this.Control[iCurrent+22]=this.st_shipment
this.Control[iCurrent+23]=this.st_inventory
this.Control[iCurrent+24]=this.p_3
this.Control[iCurrent+25]=this.st_edi
this.Control[iCurrent+26]=this.st_qc
this.Control[iCurrent+27]=this.cb_1
this.Control[iCurrent+28]=this.st_schedule
this.Control[iCurrent+29]=this.p_1
this.Control[iCurrent+30]=this.st_dailyprod
this.Control[iCurrent+31]=this.st_1
this.Control[iCurrent+32]=this.st_downtime
this.Control[iCurrent+33]=this.st_shiftschedule
end on

on w_display_app.destroy
call super::destroy
destroy(this.st_bl84)
...
Integer	li_bl84 //Alex Gerlants. 06/13/2017

ls_login = gnv_app.of_GetUserId()
li_userid = 0

//Alex Gerlants. 07/29/2016
//Added "upper()" to fix a problem when if user id has upper characters, he cannot start an application by clicking on a blue text.
CONNECT USING SQLCA;
SELECT user_id INTO :li_userid
FROM security_user
WHERE upper(login_id) = upper(:ls_login)
USING SQLCA;
...
li_sur = -1
li_bl110 = -1
li_bl84 = -1 //Alex Gerlants. 06/13/2017
...
IF ll_row > 0 THEN
	FOR ll_i = 1 TO ll_row 
		CHOOSE CASE lds_user_app.GetItemString(ll_i,"security_application_application_name") 
			...
			CASE "Line-BL84"
				li_bl84 = MAX(li_dt, lds_user_app.GetItemNumber(ll_i, "security_user_application_user_applicati"))
		...
		IF ll_row2 > 0 THEN
			FOR ll_j = 1 TO ll_row2
				CHOOSE CASE lds_group_app.GetItemString(ll_j, "security_application_application_name") 
					...
					//Alex Gerlants. 06/13/2017. Begin
					CASE "Line-BL84"
						li_bl84 = MAX(li_dt, lds_group_app.GetItemNumber(ll_i, "security_group_application_group_applica"))
					//Alex Gerlants. 06/13/2017. End
				END CHOOSE
			NEXT
		END IF
...
CHOOSE CASE li_bl84
	CASE 0 //Readonly
		st_bl84.Enabled = TRUE
	CASE 1 //Write
		st_bl84.Enabled = TRUE
	CASE ELSE
		st_bl84.Enabled = FALSE
		st_bl84.TextColor = RGB(0,0,0)
END CHOOSE
//Alex Gerlants. 06/13/2017. End
end event
...
event clicked;IF this.Enabled THEN
	Message.StringParm = "w_84_stacker_read_only" 
