$PBExportHeader$w_da_tabpg_scrap_edit.srw
forward
global type w_da_tabpg_scrap_edit from w_popup
end type
type cb_close from u_cb within w_da_tabpg_scrap_edit
end type
type cb_cancel from u_cb within w_da_tabpg_scrap_edit
end type
type cb_save from u_cb within w_da_tabpg_scrap_edit
end type
type dw_edit from u_dw within w_da_tabpg_scrap_edit
end type
end forward
...
global w_da_tabpg_scrap_edit w_da_tabpg_scrap_edit
...
iu_da_scrap_tabpg.dw_scrap.object.scrap_item_type[ll_row] = dw_edit.object.scrap_item_type[1]
iu_da_scrap_tabpg.dw_scrap.object.scrap_item_piece[ll_row] = dw_edit.object.scrap_item_piece[1]
iu_da_scrap_tabpg.dw_scrap.object.scrap_item_net_wt[ll_row] = dw_edit.object.scrap_item_net_wt[1]
iu_da_scrap_tabpg.dw_scrap.object.scrap_item_od[ll_row] = dw_edit.object.scrap_item_od[1]
iu_da_scrap_tabpg.dw_scrap.object.scrap_item_mill[ll_row] = dw_edit.object.scrap_item_mill[1]
iu_da_scrap_tabpg.dw_scrap.object.scrap_item_note[ll_row] = dw_edit.object.scrap_item_note[1]
...
public function integer wf_data_validation ();long ll_coil_wt
ll_coil_wt = iu_da_scrap_tabpg.iu_coil.get_old_nw( )
if dw_edit.object.scrap_item_net_wt[1] < 1 or dw_edit.object.scrap_item_net_wt[1] > ll_coil_wt then
	this.of_messagebox( "id_data_error", "Data error", "Invalid net weight!", Exclamation!, Ok!, 1)
	return 1
end if


if dw_edit.object.scrap_item_piece[1] < 1 or dw_edit.object.scrap_item_piece[1] > 999 then
...
on w_da_tabpg_scrap_edit.create
int iCurrent
call super::create
...
on w_da_tabpg_scrap_edit.destroy
call super::destroy
...
integer height = 189
integer taborder = 10
string dataobject = "d_quality_scrap_work_sheet_edit"
boolean vscrollbar = false
boolean livescroll = false
boolean ib_isupdateable = false
end type

event constructor;call super::constructor;iu_da_scrap_tabpg = message.powerobjectparm
this.of_setbase( true)
this.of_SetDropDownCalculator(TRUE)
this.iuo_calculator.of_Register("scrap_item_piece", &
this.iuo_calculator.NONE)
this.iuo_calculator.of_Register("scrap_item_net_wt", &
this.iuo_calculator.NONE)
