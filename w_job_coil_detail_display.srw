$PBExportHeader$w_job_coil_detail_display.srw
$PBExportComments$<Response> list coil detail in w_production inherited from pfemain/w_child
forward
global type w_job_coil_detail_display from w_child
end type
type dw_coil_detail from u_dw within w_job_coil_detail_display
end type
type cb_close from u_cb within w_job_coil_detail_display
end type
end forward
...
global w_job_coil_detail_display w_job_coil_detail_display

on w_job_coil_detail_display.create
int iCurrent
call super::create
...
on w_job_coil_detail_display.destroy
call super::destroy
