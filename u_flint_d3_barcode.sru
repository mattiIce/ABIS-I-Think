$PBExportHeader$u_flint_d3_barcode.sru
$PBExportComments$default barcode form
forward
global type u_flint_d3_barcode from u_report_object
end type
end forward
...
global u_flint_d3_barcode u_flint_d3_barcode
...
on u_flint_d3_barcode.create
call super::create
end on

on u_flint_d3_barcode.destroy
call super::destroy
end on

event constructor;call super::constructor;is_objectname = "d_report_barcode_novelis_flint"
li_allowsetup = 1
