$PBExportHeader$w_report_coil_barcode_new.srw
$PBExportComments$<popup> print barcode form for each coil
forward
global type w_report_coil_barcode_new from w_sheet
end type
type dw_report from u_dw within w_report_coil_barcode_new
end type
type cb_setzoom from u_cb within w_report_coil_barcode_new
end type
type cb_print from u_cb within w_report_coil_barcode_new
end type
type cbx_setpreview from u_cbx within w_report_coil_barcode_new
end type
type cb_close from u_cb within w_report_coil_barcode_new
end type
type st_1 from statictext within w_report_coil_barcode_new
end type
end forward
...
global w_report_coil_barcode_new w_report_coil_barcode_new

on w_report_coil_barcode_new.create
int iCurrent
call super::create
...
on w_report_coil_barcode_new.destroy
call super::destroy
...
event open;call super::open;Long ll_coil_abc_num
String ls_modstring
...
this.title = "Printing coil# :  " + String(ll_coil_abc_num) + "'s barcode ticket"
